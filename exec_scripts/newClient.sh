...
#!/bin/bash
sudo LD_LIBRARY_PATH=$LD_LIBRARY_PATH perf record -o perfMeasures/perfTPClientDPDKFinal.data -g ./dpdk_picoquicdemo --dpdk -l 0-1 -a 0000:8a:00.1 -- -X -D -A 50:6b:4b:f3:7c:71 -* 32 -@ 32 10.100.0.2 4443 /60000000000
